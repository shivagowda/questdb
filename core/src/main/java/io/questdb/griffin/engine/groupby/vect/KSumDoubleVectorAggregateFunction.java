...
public class KSumDoubleVectorAggregateFunction extends DoubleFunction implements VectorAggregateFunction {
    ...
    public void initRosti(long pRosti) {
        Unsafe.UNSAFE.putDouble(Rosti.getInitialValueSlot(pRosti, valueOffset), 0.0);
        Unsafe.UNSAFE.putDouble(Rosti.getInitialValueSlot(pRosti, valueOffset + 1), 0.0);
        Unsafe.UNSAFE.putLong(Rosti.getInitialValueSlot(pRosti, valueOffset + 2), 0);
    }
